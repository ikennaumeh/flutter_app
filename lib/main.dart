  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FlatButton(
              onPressed: () {
                //TODO: Uncomment the _confirmOrderModalBottomSheet() method to show summary of order.DONE
          ...
          actions: [
            InkWell(
              onTap: () {
                //TODO: Uncomment the setState() function to clear the price and cups.done
                //TODO: Change the 'price' to 0 when this button is clicked.done
                setState(() {
                  this.price = 0;
                  this._cupsCounter = 0;
                });
          ...
          Container(
            ...
            child: FlatButton(
              onPressed: () {
                ...
                // TODO: Increment the _cupsCounter when 'Add to Bag' button is clicked'.done
                //TODO: Call setState((){}) method to update both price and cups counter when 'Add to Bag' button is clicked.done
                setState(() {
                  this._cupsCounter++;
